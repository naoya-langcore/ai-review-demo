...
8. 助成額と授業料の比較：助成額の数値と年間授業料の数値を比較し、助成額のほうが大きい場合のみerrorとする。例：助成額120,000円 < 授業料480,000円 → 問題なし。助成額100,000円 > 授業料35,000円 → error

## 重要な注意
- findingsには問題がある項目（errorまたはwarning）のみを含めること。問題のない項目は出力しないこと
- 各チェック項目の数値を正確に比較すること。思い込みで判定せず、実際の数値同士を比較すること
